 ...
 * @author Dell
 */
@WebServlet(name = "ServletArticulo", urlPatterns = {"/ServletArticulo","/listarArticulos"})
public class ServletArticulo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            if (path.equals("/listarArticulos")) {
                ArrayList<Articulo> articulos = ArticuloDAO.getArticulo();
